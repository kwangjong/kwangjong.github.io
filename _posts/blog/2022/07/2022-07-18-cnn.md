...
![conv-gif](https://i.imgur.com/zT4yo1l.gif)
...
After convolution, the feature maps pass through an **activation function** (the most popular is ReLU). The Kaggle course describes the purpose of an activation function as:
...
[MobileNet-v3](https://arxiv.org/abs/1905.02244v5): CNN tuned for mobile devices

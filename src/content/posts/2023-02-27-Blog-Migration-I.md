...
tags: [blog-migration, fullstack]
date: 2023-02-26 23:50:00 -05:00
---

Jekyll is a popular static site generator hosted on GitHub pages, making it a convenient option for bloggers without needing a backend server. However, I decided to migrate my blog to a full-stacked website to learn and practice my web development skills. Building a full-stacked blog website will be a great opportunity to do so.
...
I decided to use **Svelte** instead. You can find more about it [here](https://kwangjong.github.io/blog/2023-03-23-Blog-Migration-II-:-Getting-Started-with-Sveltekit).
...
Oracle provided the most resources with `VM.Standard.A1.Flex`, up to 4 CPUs and 24GB memory. But, due to a shortage of servers, I couldn't acquire one. So, I had to choose GCP's `e2-micro` with 0.25~2 shared CPUs and 1GB memory. I am not expecting any traffic to my blog besides myself. So, I am hoping for 1GB of memory to work with my app. I will definitely migrate to Oracle later when it gets available.
...
Lastly, the front end will be hosted on GitHub pages which is free.

## Conclusion
Migrating from Jekyll to a full-stacked blog website will be an excellent opportunity to learn and practice my web development skills. I hope the GMV stack and my server choices work with my blog app. I will keep posting updates on my progress.
